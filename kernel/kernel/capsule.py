...
def list_capsules():
    ...
    if os.path.isdir(CAPSULES_DIR):
        # Performance optimization: Use os.scandir() instead of os.listdir() + os.path.isdir()
        # to avoid making an extra stat() system call per directory entry, significantly
        # improving traversal speed on large capsule directories.
