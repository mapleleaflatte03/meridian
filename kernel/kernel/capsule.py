...
def list_capsules():
    ...
    if os.path.isdir(CAPSULES_DIR):
        # ⚡ Bolt: Using os.scandir instead of os.listdir + os.path.isdir
        # avoids extra stat() calls because scandir caches file type metadata,
        # making directory traversal significantly faster.
