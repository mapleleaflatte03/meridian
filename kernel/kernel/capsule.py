...
def list_capsules():
    ...
    if os.path.isdir(CAPSULES_DIR):
        # PERFORMANCE: Use os.scandir instead of os.listdir + os.path.isdir to avoid redundant stat system calls.
        # This significantly speeds up iteration when dealing with many directories.
