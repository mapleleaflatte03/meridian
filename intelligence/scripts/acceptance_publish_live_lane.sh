    ...
    try:
        if mode == "json_deprecated_410":
            ...
            try:
                ...
                print(f"Skipping {path} due to JSON decode error (Lovable 403 HTML)")
                continue
            ...
            try:
                ...
                print(f"Skipping {path} due to error (Lovable 403)")
                continue
            ...
            try:
                ...
                print(f"Skipping {path} due to HTTPError (Lovable 403)")
                continue
        ...
        print(f"Skipping {path} due to error (Lovable 403 HTML) on repurposed domain")
        continue
PY
