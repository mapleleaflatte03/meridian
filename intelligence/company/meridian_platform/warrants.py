#!/usr/bin/env python3
"""
Live warrant primitives for Meridian.

The live runtime is still founding-only, but warrant objects should already
exist as first-class capsule-backed records instead of ad hoc fields on
delivery requests.
"""
