...
def _connect(db_path: str) -> sqlite3.Connection:
    ...
    # Validate against strict allowlist to prevent SQL injection in PRAGMA statement
    valid_modes = {'DELETE', 'TRUNCATE', 'PERSIST', 'MEMORY', 'WAL', 'OFF'}
    if configured_journal_mode not in valid_modes and configured_journal_mode not in {'', 'DEFAULT'}:
