...
def _connect(db_path: str) -> sqlite3.Connection:
    ...
    # SECURITY: Prevent SQL injection in PRAGMA statement
    # sqlite3 PRAGMA does not support parameterized queries
    allowed_modes = {'DELETE', 'TRUNCATE', 'PERSIST', 'MEMORY', 'WAL', 'OFF', '', 'DEFAULT'}
    if configured_journal_mode not in allowed_modes:
