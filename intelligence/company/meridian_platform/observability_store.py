...
def _connect(db_path: str) -> sqlite3.Connection:
    ...
    # 🛡️ Sentinel: Validate journal_mode against a strict allowlist to prevent PRAGMA injection
    # while preserving special control values that bypass initialization.
