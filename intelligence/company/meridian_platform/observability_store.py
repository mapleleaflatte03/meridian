...
def _connect(db_path: str) -> sqlite3.Connection:
    ...
    # Restrict to safe SQLite journal modes to prevent SQL injection via PRAGMA
    if configured_journal_mode not in {'', 'DEFAULT', 'DELETE', 'TRUNCATE', 'PERSIST', 'MEMORY', 'WAL', 'OFF'}:
