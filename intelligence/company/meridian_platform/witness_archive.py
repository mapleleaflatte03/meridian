...
Live mirrors this contract so the workspace can surface the witness archive
shape honestly, even when the host itself is not configured as a witness host.
"""
